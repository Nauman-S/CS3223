...
class IndexMgr {
     ...
     * @param tblmgr  the table manager
     * @param statmgr the statistics manager
     ...
     */
    public void createIndex(String idxname, String tblname, String fldname, IndexType idxType,
                            Transaction tx) {
        ...
        ts.setString("idxType", idxType.toString());
        ts.close();
    }
    ...
    public Map<String, IndexInfo> getIndexInfo(String tblname, Transaction tx) {
        ...
        while (ts.next()) if (ts.getString("tablename").equals(tblname)) {
            ...
            IndexType idxType = IndexType.valueOf(ts.getString("idxType"));
