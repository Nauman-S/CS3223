...
//Methods to check the status of the current token
    ...
    /**
     * Returns true if the current token is an aggregate function keyword.
     *
     * @return true if the current token is an aggregate function
     */
...
//Methods to "eat" the current token
    ...
    public void eatDelim(char d) {
        if (!matchDelim(d)) throw new BadSyntaxException();
        nextToken();
    }
    ...
    /**
     * Throws an exception if the current field is unidentifiable. Otherwise, returns
     * that field and moves to the next token.
     *
     * @return the field value of the current token
     */
    ...
    /**
     * Throws an exception if the current aggregate is unidentifiable. Otherwise, returns
     * that aggregate and moves to the next token.
     *
     * @return the aggregate value of the current token
     */
    ...
    public IndexType eatIdxType() {
        if (!matchIdxType()) throw new BadSyntaxException();
        String s = tok.sval;
        nextToken();
    ...
    private void initKeywords() {
        keywords = Arrays.asList("select", "from", "where", "and", "insert", "into", "values",
                "delete", "update", "set", "create", "table", "int", "varchar", "view", "as",
                "index", "on", "order", "by", "group", "explain", "distinct");
    }
