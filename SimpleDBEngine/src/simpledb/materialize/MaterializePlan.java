 ...
 */
public class MaterializePlan extends Plan {
    ...
    /**
     * Return the estimated number of blocks in the materialized table. It does
    ...
    /**
     * Return the number of records in the materialized table, which is the same as
    ...
    /**
     * Return the number of distinct field values, which is the same as in the
     * underlying plan.
     *
    ...
    /**
     * Return the schema of the materialized table, which is the same as in the
     * underlying plan.
     *
    ...
    public String format(int indent) {
        ...
        sb.append(String.format("%s{%s}", indentStr, srcplan.format(indent)));
        return sb.toString();
    }
}
