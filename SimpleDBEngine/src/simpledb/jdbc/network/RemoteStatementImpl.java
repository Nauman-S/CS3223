...
class RemoteStatementImpl extends UnicastRemoteObject implements RemoteStatement {
	...
	/**
	 * Executes the specified SQL explain command. The method calls the query
	 * planner to create a plan for the query.
	 * 
	 * @see simpledb.jdbc.network.RemoteStatement#getQueryPlan(java.lang.String)
	 */
	public Plan getQueryPlan(String sql) throws RemoteException {
		try {
			Transaction tx = rconn.getTransaction();
